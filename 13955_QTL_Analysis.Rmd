  ...
  for(i in unique(d$chr)){
    ...
    c <- ggplot(data = b, aes(x = qtl, y = pos, color = chr))+ # Make plot out of object b
      ...
      labs(title = i, # Make the title of the graph the name of the chromosome 
           color = "Color Legend", # Name the legend 
