...
for (i in traits){
  ...
  perms <- scanone(cross_file, 
                   ...
                   method = "hk", 
                   n.perm = nperms, 
                   n.cluster = ifelse(parallel::detectCores()-1>=10, 10, parallel::detectCores()-1)) #set threshold
  print("Done")
...
This line I am running this file that I wrote elsewhere.

```{r}
# Render the Markdown file to PDF
if("supplemental_information_2.Rmd" %in% list.files()){
...
markdown_content <- c('
---
title: \"Supplemental Information 7\"
output: 
  pdf_document:
    extra_dependencies: ["geometry"]
    latex_engine: xelatex
...
# Write the Markdown content to a file
writeLines(markdown_content, "supplemental_information_7.Rmd")

# Render the Markdown file to PDF
rmarkdown::render("supplemental_information_7.Rmd", output_format = "pdf_document")
```
